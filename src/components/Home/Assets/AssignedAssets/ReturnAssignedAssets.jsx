...
const ReturnAssignedAssets = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/return-assets`, {
                method: "POST",
                body: formDataMain
            });
            if (!response.ok) {
            ...
            await handleUpdateReturn(params.id)
            navigate("/returnedassets");
        } catch (error) {
    ...
    const handleUpdateReturn = async (id) => {
        try {
            await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/update-return/${id}`, { method: 'PUT' });
        }
        catch (error) {
            console.error(error);
        }
            ...
            <section className="section">
                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        ...
                        <input type="date" className="form-control" name="return_date" id="assign_date"
                            value={formData.return_date} onChange={handleInputChange} />
                    </div>
                ...
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <br />
                        <textarea name="return_description" id="" className="form-control" cols="30" rows="5"
                            value={formData.return_description} onChange={handleInputChange}></textarea>
                    </div>
                    <div className="col-md-4">
                        {imagePreview && (
                            <div>
...
export default ReturnAssignedAssets