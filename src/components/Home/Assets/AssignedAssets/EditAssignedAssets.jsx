...
const EditAssignedAssets = () => {
    ...
    useEffect(() => {
        if (assignedAssets) {
            setFormData({
                ...
                assign_description: assignedAssets.description,
                assign_date: assignedAssets.assign_date.slice(0, 10)
            });
        }
    }, [assignedAssets]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (selectedImage) {
            ...
            formDataMain.append('image', assignedAssets.image);
        }
...
export default EditAssignedAssets